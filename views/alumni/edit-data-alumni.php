...
if (isset($_POST['updateAlumni']))
{
  ...
  $updateAlumni = $objAdmin->updateAlumni($nis, $nama, $tempat_lahir, $tgl_lahir, $jekel, $agama,$jurusan,$alamat_rumah,$alamat_sekarang,$hp,$email,$angakatan,$lulusan,$nama_ayah,$nama_ibu,$alamat_ortu,$hp_ortu );
  if ($updateAlumni) {
      echo "<script>
      swal(
        'Save Alumni Success!',
